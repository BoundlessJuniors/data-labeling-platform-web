      ...
      <section id="features" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20" aria-labelledby="features-title">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <article class="card hover:shadow-lg transition-shadow">
            ...
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Test Ödeme Akışı</h3>
            <p class="text-gray-600 dark:text-slate-400">
              Mock ödeme ve escrow yaşam döngüsüyle sözleşme sürecini uçtan uca test edin. Gerçek ödeme veya kart bilgisi alınmaz.
            </p>
          </article>
