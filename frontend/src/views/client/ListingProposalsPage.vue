      ...
      <div v-if="pendingProposals.length > 0">
        ...
        <div class="space-y-3">
          <article
            ...
            :key="proposal.id"
            class="card hover:shadow-lg transition-shadow border-l-4 border-l-yellow-400"
          >
            <div class="flex flex-col lg:flex-row justify-between gap-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center gap-4 text-sm mb-2">
                  <span class="font-bold text-green-600 dark:text-green-400">
                    Teklif: {{ formatPrice(proposal.priceQuote, listing?.currency) }}
                  </span>
                ...
                <div v-if="proposal.coverLetter" class="mt-2">
                  <p class="text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <button
                      ...
                      @click="openCoverLetter(proposal)"
                    >
                      Devamını oku
                    </button>
                  </p>
              ...
              <div class="flex items-center gap-2 flex-shrink-0">
                <BaseButton
                  variant="primary"
                  size="sm"
                  :disabled="proposalsStore.actionLoading"
                  class="!bg-green-600 hover:!bg-green-700 focus:!ring-green-500"
                  @click="openAcceptModal(proposal)"
                >
              ...
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ formatPrice(proposal.priceQuote, listing?.currency) }} · {{ formatDate(proposal.createdAt) }}
                  </p>
                </div>
              </div>
